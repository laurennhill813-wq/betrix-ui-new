...
import {
  ...
  profileMenu,
  helpMenu,
  // Consolidated live-league handler implemented later in this file.
...
async function handleLeagueLiveCallback(data, chatId, userId, redis, services) {
// Duplicate handler removed: consolidated implementation lives earlier in file.
// Duplicate `handleLeagueLiveCallback` removed (consolidated above)
// ----------------------
// Betslip helpers
// ----------------------
