...
export async function analyseFixtureWithBetrixx(fixture, opts = {}) {
  ...
  const systemPrompt = persona.getSystemPrompt({
    includeContext: { mode: "analysis", verbosity: "full" },
  });
  ...
  const schemaExample = JSON.stringify(
    {
      ...
      predictions: [
        {
          market:
            "Match Winner|Both Teams To Score|Over/Under|Correct Score|Other",
      ...
      preferredBets: [
        {
          option: "Home Win - Moneyline",
          odds: "1.95 or '-' if not available",
          confidence: 0.0,
          suggested_stake_pct: 0,
