export const PRICING_TIERS = {
  ...
  basketball: {
    starter: {
      name: "Basketball Starter",
      price: 9.99,
      features: ["Basic stats", "Weekly insights", "Game predictions"],
    },
    pro: {
      name: "Basketball Pro",
      price: 24.99,
  ...
  tennis: {
    starter: {
      name: "Tennis Starter",
      price: 9.99,
      features: ["Match odds", "Weekly tips", "Player rankings"],
    },
    pro: {
      name: "Tennis Pro",
      price: 24.99,
  ...
  cricket: {
    starter: {
      name: "Cricket Starter",
      price: 9.99,
      features: ["Match odds", "Weekly insights", "Team stats"],
    },
    pro: {
      name: "Cricket Pro",
      price: 24.99,
  ...
  baseball: {
    starter: {
      name: "Baseball Starter",
      price: 9.99,
      features: ["Game odds", "Weekly tips", "Team rankings"],
    },
    pro: {
      name: "Baseball Pro",
      price: 24.99,
  ...
  hockey: {
    starter: {
      name: "Hockey Starter",
      price: 9.99,
      features: ["Game odds", "Weekly insights", "Team stats"],
    },
    pro: {
      name: "Hockey Pro",
      price: 24.99,
  ...
  rugby: {
    starter: {
      name: "Rugby Starter",
      price: 9.99,
      features: ["Match odds", "Weekly tips", "Team rankings"],
    },
    pro: {
      name: "Rugby Pro",
      price: 24.99,
  ...
  mma: {
    starter: {
      name: "MMA Starter",
      price: 9.99,
      features: ["Fight odds", "Weekly insights", "Fighter rankings"],
    },
    pro: {
      name: "MMA Pro",
      price: 24.99,
  ...
  boxing: {
    starter: {
      name: "Boxing Starter",
      price: 9.99,
      features: ["Fight odds", "Weekly tips", "Boxer rankings"],
    },
    pro: {
      name: "Boxing Pro",
      price: 24.99,
  ...
  soccer: {
    starter: {
      name: "Soccer Starter",
      price: 9.99,
      features: ["Match odds", "Weekly insights", "League standings"],
    },
    pro: {
      name: "Soccer Pro",
      price: 24.99,
