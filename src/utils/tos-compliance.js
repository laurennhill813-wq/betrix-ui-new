...
export const DATA_DISCLAIMERS = {
  goal: {
    provider: "Goal.com",
    disclaimer:
      "⚠️ Data sourced from Goal.com (public web scraping). Goal.com is a third-party service. Please verify critical information directly on Goal.com. BETRIX is not affiliated with Goal.com.",
  ...
  flashscore: {
    ...
    disclaimer:
      "⚠️ Data sourced from Flashscore.com (public web scraping). Flashscore.com is a third-party service. Please verify critical information directly on Flashscore.com. BETRIX is not affiliated with Flashscore.com.",
  ...
  oddschecker: {
    ...
    disclaimer:
      "⚠️ Odds sourced from Oddschecker.com (public web scraping). Oddschecker.com is a third-party service. Odds are for reference only and may not reflect live market prices. BETRIX is not affiliated with Oddschecker.com.",
  ...
  betfair: {
    ...
    disclaimer:
      "⚠️ Exchange odds sourced from Betfair.com (public web scraping). Betfair.com is a third-party service. Exchange odds may differ from bookmaker odds. BETRIX is not affiliated with Betfair.com.",
  ...
  espn: {
    provider: "ESPN",
    disclaimer:
      "✅ Data sourced from ESPN public API. ESPN is a trusted sports data provider.",
...
export function getDisclaimer(provider) {
  const disc =
    DATA_DISCLAIMERS[provider.toLowerCase()] || DATA_DISCLAIMERS.goal;
  return disc;
}
 ...
 */
export async function validateScraperRateLimit(
  provider,
  ...
  if (delta < rateLimitMs) {
    ...
    logger.warn(
      `[RateLimit] ${disc.provider} rate limit: need to wait ${delay}ms`,
    );
