...
const TICKER_ENABLED =
  String(process.env.MEDIA_TICKER_ENABLED || "false").toLowerCase() === "true";
const TICKER_INTERVAL_MINUTES = Number(
  process.env.MEDIA_TICKER_INTERVAL_MINUTES || 60,
);
...
async function getNextMediaItem() {
  ...
  return {
    photoUrl:
      process.env.SAMPLE_MEDIA_URL ||
      "https://via.placeholder.com/1024x512.png?text=BETRIX+Highlight",
    caption:
      process.env.SAMPLE_MEDIA_CAPTION ||
      "🔥 BETRIX Highlight — stay tuned for more!",
  };
}
