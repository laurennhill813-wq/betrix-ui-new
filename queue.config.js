...
const REDIS_URL =
  ...
  "redis://default:REDACTED@redis-14261.c282.east-us-mz.azure.cloud.redislabs.com:14261";
const u = new URL(REDIS_URL);

function safeConnection() {
  const useTls =
    u.protocol === "rediss:" || process.env.REDIS_TLS_FORCE === "1";
  return {
    host: u.hostname,
