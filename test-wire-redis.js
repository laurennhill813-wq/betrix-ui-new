...
async function run() {
  ...
  if (!url) {
    console.error(
      "Please set REDIS_URL in the environment before running this test.",
    );
    process.exit(1);
  }
  ...
  console.log(
    "Fetching live matches (league 39) to trigger provider health writes...",
  );
