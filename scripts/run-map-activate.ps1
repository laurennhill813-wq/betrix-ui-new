...
Write-Host "Writing mapping for TXN1765195908263Z07JK8 -> ORDER-TXN2"
node .\scripts\set-redis-mapping.mjs $env:REDIS_URL TXN1765195908263Z07JK8 ORDER-TXN2 admin 300

Write-Host "Writing mapping for TXN1765202976351OY19X5 -> ORDER-TXN1"
node .\scripts\set-redis-mapping.mjs $env:REDIS_URL TXN1765202976351OY19X5 ORDER-TXN1 admin 300

Write-Host "Activating ORDER-TXN2 for TXN1765195908263Z07JK8"
node .\scripts\force-activate.mjs $env:REDIS_URL TXN1765195908263Z07JK8

Write-Host "Activating ORDER-TXN1 for TXN1765202976351OY19X5"
node .\scripts\force-activate.mjs $env:REDIS_URL TXN1765202976351OY19X5
