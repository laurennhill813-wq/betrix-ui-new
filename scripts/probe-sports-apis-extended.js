...
const apiFootballKey =
  process.env.API_FOOTBALL_KEY || process.env.API_SPORTS_KEY;
const sportsdataKey =
  process.env.SPORTSDATA_API_KEY || process.env.SPORTSDATA_KEY;
const sportmonksKey =
  process.env.SPORTSMONKS_API || process.env.SPORTSMONKS_API_KEY;

const apiFootballVariants = [
  {
    name: "rapidapi",
    base:
      process.env.API_FOOTBALL_BASE || "https://api-football-v3.p.rapidapi.com",
    headers: {
  ...
  {
    name: "rapidapi-alt-host",
    base: "https://api-football.p.rapidapi.com",
    headers: {
      "x-rapidapi-key": apiFootballKey,
  ...
  {
    name: "apisports-alt",
    base: "https://football.api-sports.io",
    headers: { "x-apisports-key": apiFootballKey },
  },
];
...
const sportsdataVariants = [
  {
    name: "api.sportsdata.io",
    base: process.env.SPORTSDATA_BASE || "https://api.sportsdata.io",
  },
  {
    name: "sportsdata.io",
    base: process.env.SPORTSDATA_HOST || "https://sportsdata.io",
  },
];
...
const sportmonksVariants = [
  ...
  {
    name: "sportsmonks-soccer-api",
    base: "https://soccer.sportmonks.com/api/v2",
  },
