...
const url =
  process.argv[3] ||
  process.env.LIPANA_TEST_URL ||
  "https://pseudoasymmetrical-fibrillose-racheal.ngrok-free.dev/webhook/mpesa";
const secret = process.env.LIPANA_SECRET;

if (!tx) {
  console.error(
    "Usage: node scripts/post_signed_webhook.js <tx_ref> [webhook_url]",
  );
  process.exit(2);
}
if (!secret) {
...
const payload = {
  ...
  data: { id: tx, amount: 300, phone: "254741118999" },
};
