...
(async () => {
  ...
  console.log('RESULT:', { status: r.status, ok: r.ok, bodyType: typeof r.body });
  if (typeof r.body === 'string') console.log('BODY_TEXT:', r.body.substring(0, 500));
  else console.log('BODY_JSON_SAMPLE:', JSON.stringify(r.body).substring(0, 500));
  process.exit(0);
})();
