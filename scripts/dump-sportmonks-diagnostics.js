...
async function main() {
  try {
    ...
    print(
      "CONFIG.SPORTSMONKS_BASE (env)",
      process.env.SPORTSMONKS_BASE || "(unset)",
    );
    print(
      "SPORTSMONKS_API_KEY present",
      process.env.SPORTSMONKS_API_KEY ? "yes" : "no",
    );
    print("SPORTSMONKS_INSECURE", process.env.SPORTSMONKS_INSECURE || "false");
    print(
      "SPORTSMONKS_TLS_PAUSE_SECONDS",
      process.env.SPORTSMONKS_TLS_PAUSE_SECONDS || "(unset)",
    );
