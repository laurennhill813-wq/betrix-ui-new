...
try {
  if (
    ...
    typeof globalThis.__copilotReadyInserted === "undefined"
  ) {
  ...
  console.error("COPILOT-READY-ENDPOINT ERROR", e);
}
...
try {
  if (
    typeof app !== "undefined" &&
    typeof globalThis.__copilotOpsInserted === "undefined"
  ) {
      ...
      async function doShutdown(signal) {
        ...
        try {
          if (
            ...
            console.info("No queue.drain found; best-effort drain.");
          }
        } catch (e) {
  ...
  console.error("COPILOT-OPS-LIFECYCLE ERROR", e);
}
