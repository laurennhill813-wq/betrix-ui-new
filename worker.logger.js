    ...
    for (const candidate of candidates) {
      try {
        ...
        try {
          ...
          console.warn("WRAPPER_RESOLVE_FAIL", {
            candidate,
            err: resErr && (resErr.message || String(resErr)),
          });
          continue;
        }
        ...
        try {
          ...
          if (mod && typeof mod.start === "function") {
            ...
            console.info("WORKER_MODULE_LOADED_SIDE_EFFECTS", {
              via: candidate,
            });
            loaded = true;
            break;
          ...
          console.error("WRAPPER_REQUIRE_THROW", {
            candidate,
            err:
              requireErr &&
              (requireErr.stack || requireErr.message || String(requireErr)),
          });
        }
      } catch (e) {
        console.error(
